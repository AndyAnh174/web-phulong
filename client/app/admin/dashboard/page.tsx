  ...
  const fetchDashboardData = useCallback(async (isRefresh = false) => {
    try {
      ...
      const [summaryResponse, ordersResponse, servicesResponse] = await Promise.all([
        fetch("http://14.187.207.48:12122/api/dashboard/summary", { headers }),
        fetch("http://14.187.207.48:12122/api/dashboard/recent-orders?limit=5", { headers }),
        fetch("http://14.187.207.48:12122/api/dashboard/popular-services?limit=5", { headers })
      ])
