...
export default function AdminBannersPage() {
  ...
  const fetchBanners = useCallback(async (isRefresh = false) => {
    ...
    try {
      ...
      let url = `http://14.187.218.183:12122/api/banners`
  ...
  const handleCreateBanner = async () => {
    ...
    try {
      ...
      const response = await fetch("http://14.187.218.183:12122/api/banners/upload-with-banner", {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleUpdateBanner = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://14.187.218.183:12122/api/banners/${selectedBanner.id}`, {
        method: "PUT",
        headers: {
  ...
  const handleDeleteBanner = async () => {
    ...
    try {
      ...
      const response = await fetch(`http://14.187.218.183:12122/api/banners/${selectedBanner.id}?delete_image=true`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const handleToggleActive = async (banner: Banner) => {
    ...
    try {
      ...
      const response = await fetch(`http://14.187.218.183:12122/api/banners/${banner.id}/toggle`, {
        method: "PATCH",
        headers: {
          Authorization: `Bearer ${token}`,
        },
                      ...
                      <TableCell>
                        <div className="flex items-center gap-3">
                          <div className="relative w-16 h-10 rounded border overflow-hidden">
                            <Image
                              src={banner.image.url.startsWith('http') ? banner.image.url : `http://14.187.218.183:12122${banner.image.url}`}
                      ...
                      <TableCell className="text-right">
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem onClick={() => window.open(banner.image.url.startsWith('http') ? banner.image.url : `http://14.187.218.183:12122${banner.image.url}`, '_blank')}>
                              <Eye className="mr-2 h-4 w-4" />
                              Xem ảnh
                            </DropdownMenuItem>
                            <DropdownMenuItem onClick={() => copyUrlToClipboard(banner.image.url.startsWith('http') ? banner.image.url : `http://14.187.218.183:12122${banner.image.url}`)}>
          ...
          <div className="grid gap-6 py-4">
            ...
            {selectedBanner && (
              <div className="space-y-2">
                ...
                <div className="relative w-full h-32 border rounded-lg overflow-hidden">
                  <Image
                    src={selectedBanner.image.url.startsWith('http') ? selectedBanner.image.url : `http://14.187.218.183:12122${selectedBanner.image.url}`}
